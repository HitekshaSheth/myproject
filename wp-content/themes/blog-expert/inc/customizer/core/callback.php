...
if ( ! function_exists( 'blog_expert_is_select_page_slider' ) ) :
	 ...
	 */
	function blog_expert_is_select_page_slider( $control ) {
...
if ( ! function_exists( 'blog_expert_is_select_cat_slider' ) ) :
	 ...
	 * @return bool Whether the control is active to the current preview.
	 */
	function blog_expert_is_select_cat_slider( $control ) {
